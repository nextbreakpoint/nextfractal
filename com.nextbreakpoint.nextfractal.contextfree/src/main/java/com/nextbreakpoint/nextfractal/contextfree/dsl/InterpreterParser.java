...
import com.nextbreakpoint.nextfractal.contextfree.dsl.ParserResult.Type;
...
public class InterpreterParser {
	private static final Logger logger = Logger.getLogger(InterpreterParser.class.getName());
	...
	public ParserResult parse(String source) throws ParserException {
		...
		return new ParserResult(cfdg, Type.INTERPRETER, source, errors);
	}
