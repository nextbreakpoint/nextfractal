...
public abstract class AbstractOrbitTrapRuntime<T extends OrbitTrapExtensionConfig> extends OrbitTrapExtensionRuntime<T> {
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.mandelbrot.orbitTrap.extension.OrbitTrapExtensionRuntime#prepareForProcessing(com.nextbreakpoint.nextfractal.core.util.DoubleVector2D, double, double)
	 */
	@Override
