...
public class UniversalConfigXMLImporterRuntime extends ExtensionConfigXMLImporterExtensionRuntime {
	...
	private class UniversalConfigXMLImporter extends AbstractIncolouringPaletteConfigXMLImporter<UniversalConfig> {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.mandelbrot.extensions.incolouringFormula.AbstractIncolouringPaletteConfigXMLImporter#getPropertiesSize()
		 */
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.mandelbrot.extensions.incolouringFormula.AbstractIncolouringPaletteConfigXMLImporter#importProperties(com.nextbreakpoint.nextfractal.mandelbrot.extensions.incolouringFormula.AbstractPaletteExtensionConfig, java.util.List)
		 */
		@Override
