...
import com.nextbreakpoint.nextfractal.mandelbrot.extensions.incolouringFormula.AbstractIncolouringFormulaRuntime;
...
public class BinaryRuntime extends AbstractIncolouringFormulaRuntime<BinaryConfig> {
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.mandelbrot.extensions.incolouringFormula.AbstractIncolouringFormulaRuntime#prepareForRendering(int)
	 */
	@Override
