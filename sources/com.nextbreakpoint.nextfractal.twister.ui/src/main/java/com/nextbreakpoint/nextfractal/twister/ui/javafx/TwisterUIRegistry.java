 ...
 */
public class TwisterUIRegistry {
	...
	private static class RegistryHolder {
		private static final TwisterUIRegistry instance = new TwisterUIRegistry();
	}

	private TwisterUIRegistry() {
	 ...
	 * @return
	 */
	public static TwisterUIRegistry getInstance() {
