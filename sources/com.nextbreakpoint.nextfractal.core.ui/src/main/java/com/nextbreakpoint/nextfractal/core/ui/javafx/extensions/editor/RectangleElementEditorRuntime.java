...
//			textFields[0] = GUIFactory.createTextField(String.valueOf(rectangle.getX()), CoreUIExtensionResources.getInstance().getString("tooltip.rectangleLeft"));
...
//			textFields[1] = GUIFactory.createTextField(String.valueOf(rectangle.getY()), CoreUIExtensionResources.getInstance().getString("tooltip.rectangleTop"));
...
//			textFields[2] = GUIFactory.createTextField(String.valueOf(rectangle.getW()), CoreUIExtensionResources.getInstance().getString("tooltip.rectangleWidth"));
...
//			textFields[3] = GUIFactory.createTextField(String.valueOf(rectangle.getH()), CoreUIExtensionResources.getInstance().getString("tooltip.rectangleHeight"));
