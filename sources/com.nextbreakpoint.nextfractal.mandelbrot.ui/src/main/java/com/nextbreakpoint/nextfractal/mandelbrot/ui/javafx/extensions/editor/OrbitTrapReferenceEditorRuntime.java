...
import com.nextbreakpoint.nextfractal.mandelbrot.orbitTrap.OrbitTrapExtensionReferenceNodeValue;
...
public class OrbitTrapReferenceEditorRuntime extends ConfigurableReferenceEditorRuntime {
	...
	protected List<ConfigurableExtension<?, ?>> getExtensionList() {
		...
		for (ConfigurableExtension<?, ?> extension : MandelbrotRegistry.getInstance().getOrbitTrapRegistry().getConfigurableExtensionList()) {
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.core.ui.javafx.editor.ConfigurableReferenceEditorRuntime#createNodeValue(com.nextbreakpoint.nextfractal.core.runtime.extension.ConfigurableExtensionReference)
	 */
