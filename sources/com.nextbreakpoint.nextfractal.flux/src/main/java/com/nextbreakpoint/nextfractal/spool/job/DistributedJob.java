...
public class DistributedJob implements DistributedJobInterface {
	...
	private volatile SpoolData clip;
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.queue.spool.DistributedJobInterface#getSpoolData()
	 */
	@Override
	public synchronized SpoolData getClip() {
		return clip;
	}
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.queue.spool.DistributedJobInterface#setClip(com.nextbreakpoint.nextfractal.SpoolData.TwisterClip)
	 */
	@Override
	public synchronized void setClip(final SpoolData clip) {
		if (thread != null) {
			throw new IllegalStateException();
		}
		this.clip = clip;
