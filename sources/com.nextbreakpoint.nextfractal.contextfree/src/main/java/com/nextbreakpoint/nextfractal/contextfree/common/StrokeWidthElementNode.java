...
public abstract class StrokeWidthElementNode extends AttributeNode {
	...
	protected class StrokeWidthNodeEditor extends NumberNodeEditor {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.tree.NumberNodeEditor#getMaximum()
		 */
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.tree.NumberNodeEditor#getMinimum()
		 */
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.tree.NumberNodeEditor#getStep()
		 */
		@Override
