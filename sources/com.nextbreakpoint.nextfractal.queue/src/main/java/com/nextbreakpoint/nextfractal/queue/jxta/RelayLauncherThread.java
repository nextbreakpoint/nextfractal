		...
		try {
			...
			try {
				...
				if ((properties.get("workspace") == null) || (System.getProperty("nextfractal.workspace") != null)) {
					workspace = new File(System.getProperty("nextfractal.workspace", System.getProperty("user.home") + "/JXTARelay-workspace").replace("${user.home}", System.getProperty("user.home")));
