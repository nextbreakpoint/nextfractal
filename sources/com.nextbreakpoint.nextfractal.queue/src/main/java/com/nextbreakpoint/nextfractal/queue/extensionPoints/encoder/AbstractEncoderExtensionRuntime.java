...
public abstract class AbstractEncoderExtensionRuntime<T extends EncoderExtensionConfig> extends EncoderExtensionRuntime<T> {
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.queue.extensionPoints.encoder.EncoderExtensionRuntime#addProgressListener(com.nextbreakpoint.nextfractal.queue.ProgressListener)
	 */
	@Override
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.queue.extensionPoints.encoder.EncoderExtensionRuntime#removeProgressListener(com.nextbreakpoint.nextfractal.queue.ProgressListener)
	 */
	@Override
