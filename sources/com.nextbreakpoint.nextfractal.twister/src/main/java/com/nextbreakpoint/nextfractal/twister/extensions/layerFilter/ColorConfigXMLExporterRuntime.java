...
public class ColorConfigXMLExporterRuntime extends ExtensionConfigXMLExporterExtensionRuntime {
	...
	private class ColorConfigXMLExporter extends AbstractLayerFilterConfigXMLExporter<ColorConfig> {
		/**
		 * @see com.nextbreakpoint.nextfractal.twister.extensions.layerFilter.AbstractLayerFilterConfigXMLExporter#getConfigElementClassId()
		 */
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.twister.extensions.layerFilter.AbstractLayerFilterConfigXMLExporter#exportToElement(com.nextbreakpoint.nextfractal.twister.layerFilter.extension.LayerFilterExtensionConfig, com.nextbreakpoint.nextfractal.core.xml.XMLNodeBuilder)
		 */
		@Override
