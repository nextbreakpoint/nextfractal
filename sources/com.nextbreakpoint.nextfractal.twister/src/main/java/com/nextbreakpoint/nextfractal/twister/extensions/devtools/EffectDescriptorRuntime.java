...
public class EffectDescriptorRuntime extends DescriptorExtensionRuntime {
	...
	public ProcessorDescriptor createDescriptor(String elementName, String defaultValue, ProcessorCardinality cardinality) {
		return new ProcessorDescriptor(elementName, "Effect", EffectConfigElement.CLASS_ID, "com.nextbreakpoint.nextfractal.twister.effect", "EffectConfigElement", "com.nextbreakpoint.nextfractal.twister.effect", "EffectRuntimeElement", null, null, null, null, null, null, null, null, "", "", null, null, null, "get", "set", cardinality);
	}
