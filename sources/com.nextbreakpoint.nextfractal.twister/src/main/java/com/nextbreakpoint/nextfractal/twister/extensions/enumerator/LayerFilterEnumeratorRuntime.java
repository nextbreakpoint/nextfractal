 ...
 *
 */
package com.nextbreakpoint.nextfractal.twister.extensions.enumerator;
...
public class LayerFilterEnumeratorRuntime extends EnumeratorExtensionRuntime {
	...
	public ExtensionWrapper getExtension(final String extensionId) throws JSException {
		try {
			return new ExtensionWrapper(TwisterRegistry.getInstance().getLayerFilterExtension(extensionId));
		}
