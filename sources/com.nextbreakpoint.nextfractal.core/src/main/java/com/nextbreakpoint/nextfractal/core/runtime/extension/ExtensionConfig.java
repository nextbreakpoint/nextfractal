...
public abstract class ExtensionConfig implements Serializable, Cloneable {
	...
	private List<ElementChangeListener> getListenerList() {
		if (listenerList == null) {
			listenerList = new ArrayList<ElementChangeListener>(1);
		}
		return listenerList;
	}
	 ...
	 */
	protected void fireValueChanged(final ElementChangeEvent e) {
	...
	private class EventDispatcher implements ElementChangeListener {
		/**
