...
public abstract class NodeEditor {
	...
	private abstract class AbstractCommand implements NodeCommand {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeCommand#consume()
		 */
		@Override
		public void consume() {
			consumed = true;
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeCommand#isConsumed()
		 */
		@Override
	...
	private class SetValueCommand extends AbstractCommand {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeCommand#accept(com.nextbreakpoint.nextfractal.core.runtime.model.NodeSession, long)
		 */
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeCommand#accept()
		 */
		@Override
		public void cancel() {
	...
	private class ForwardCommand implements NodeCommand {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeCommand#cancel()
		 */
		@Override
		public void cancel() {
			if (command != null) {
