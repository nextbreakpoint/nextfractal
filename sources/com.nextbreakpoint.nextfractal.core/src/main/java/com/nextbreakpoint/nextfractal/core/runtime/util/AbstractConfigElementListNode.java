...
public abstract class AbstractConfigElementListNode<T extends ConfigElement> extends DefaultNode {
	...
	/**
	 * @see com.nextbreakpoint.nextfractal.core.runtime.model.ListNode#getChildValueType()
	 */
	...
	protected class ListNodeEditor extends NodeEditor {
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeEditor#doAppendNode(com.nextbreakpoint.nextfractal.core.runtime.model.NodeObject)
		 */
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeEditor#doInsertNodeAfter(int, com.nextbreakpoint.nextfractal.core.runtime.model.NodeObject)
		 */
		@SuppressWarnings("unchecked")
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeEditor#doInsertNodeBefore(int, com.nextbreakpoint.nextfractal.core.runtime.model.NodeObject)
		 */
		@SuppressWarnings("unchecked")
		@Override
		...
		/**
		 * @see com.nextbreakpoint.nextfractal.core.runtime.model.NodeEditor#doRemoveNode(int)
		 */
		@Override
