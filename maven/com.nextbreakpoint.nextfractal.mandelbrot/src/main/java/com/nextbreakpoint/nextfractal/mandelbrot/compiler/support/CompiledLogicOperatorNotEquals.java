...
public class CompiledLogicOperatorNotEquals implements CompiledCondition {
	private CompiledExpression[] operands;
	
	public CompiledLogicOperatorNotEquals(ExpressionContext context, CompiledExpression[] operands) {
