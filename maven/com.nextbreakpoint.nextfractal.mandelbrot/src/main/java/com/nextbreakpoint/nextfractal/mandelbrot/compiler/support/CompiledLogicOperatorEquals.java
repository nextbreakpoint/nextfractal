...
public class CompiledLogicOperatorEquals implements CompiledCondition {
	private CompiledExpression[] operands;
	
	public CompiledLogicOperatorEquals(ExpressionContext context, CompiledExpression[] operands) {
