...
public class CompiledOperatorPowZ implements CompiledExpression {
	private CompiledExpression exp1;
	private CompiledExpression exp2;
	private int index;
	
	public CompiledOperatorPowZ(ExpressionContext context, CompiledExpression exp1, CompiledExpression exp2) {
