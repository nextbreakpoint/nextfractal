...
public class InterpreterCompiledOrbit {
	...
	public InterpreterCompiledOrbit(Collection<CompilerVariable> orbitVariables, Collection<CompilerVariable> stateVariables) {
