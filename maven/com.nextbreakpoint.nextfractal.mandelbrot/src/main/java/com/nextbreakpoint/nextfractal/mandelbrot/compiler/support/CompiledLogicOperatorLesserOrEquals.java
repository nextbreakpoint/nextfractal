...
public class CompiledLogicOperatorLesserOrEquals implements CompiledCondition {
	private CompiledExpression[] operands;
	
	public CompiledLogicOperatorLesserOrEquals(ExpressionContext context, CompiledExpression[] operands) {
