...
public class InterpreterLogicOperatorEquals implements CompiledCondition {
	private CompiledExpression[] operands;
	
	public InterpreterLogicOperatorEquals(ExpressionContext context, CompiledExpression[] operands) {
