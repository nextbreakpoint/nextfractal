...
public class CompiledOperatorMulZ implements CompiledExpression {
	private CompiledExpression exp1;
	private CompiledExpression exp2;
	private int index;
	
	public CompiledOperatorMulZ(ExpressionContext context, CompiledExpression exp1, CompiledExpression exp2) {
