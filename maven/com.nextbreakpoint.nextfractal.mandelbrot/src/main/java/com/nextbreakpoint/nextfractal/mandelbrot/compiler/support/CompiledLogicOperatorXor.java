...
public class CompiledLogicOperatorXor implements CompiledCondition {
	private CompiledCondition[] operands;
	
	public CompiledLogicOperatorXor(ExpressionContext context, CompiledCondition[] operands) {
